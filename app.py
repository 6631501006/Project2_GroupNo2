...
with col1:
    if st.button("📋 เอกสารที่ต้องใช้"):
        st.session_state.preset_query = "เอกสารที่ต้องใช้ในการสมัครมีอะไรบ้าง"
with col2:
    if st.button("💰 วงเงินสนับสนุน"):
        st.session_state.preset_query = "ได้รับเงินสนับสนุนเท่าไหร่"
with col3:
